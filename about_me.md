...
ปัจจุบันยังมีการใช้งานอยู่เป็นระยะ ๆ ลองเล่นดิสโทรตัวอื่น ๆ ลงบน VM บ้าง ลงในโน้ตบุ๊คมือสองบ้าง เรียนรู้วิธีการใช้งานการตั้งค่าต่าง ๆ และร่วมในการแปลในโครงการของ [Xfce ภาษาไทย](./traduko_xfce_th.md) [ภาษาเอสเปรันโต](./traduko_xfce.md)
...
GUI: Xfce/JWM (มันลื่น ไม่ค้าง มีโปรแกรมพาแนลและปลั๊กอินครบตามความต้องการ (ชอบ Time-out มาก))
Coding: Vscodium
