...
ปัจจุบันยังมีการใช้งานอยู่เป็นระยะ ๆ ลองเล่นดิสโทรตัวอื่น ๆ ลงบน VM บ้าง ลงในโน้ตบุ๊คมือสองบ้าง เรียนรู้วิธีการใช้งานการตั้งค่าต่าง ๆ และร่วมในการแปลในโครงการของ [Xfce ภาษาไทย](./traduko_xfce_th.md) [Xfce ภาษาเอสเปรันโต](./traduko_xfce.md) = ยังไม่เสร็จ [หรือที่ [รวมงานรแปล](/mytranslations.md)]
...
DE: Xfce (มันลื่น ไม่ค้าง มีโปรแกรมพาแนลและปลั๊กอินครบตามความต้องการ (ชอบ Time-out มาก))

WM: Xfwm / JWM ชอบในความเรียบง่าย แต่ไม่ได้ใช้ประจำ

Tiling Windows : Cortile ช่วยในการจัดระเบียบหน้าต่าง

Coding: Vscodium สำหรับเขียนโค้ด เป็นง่ายอดิเรก

Terminal: xfce-terminal แน่นอน เพราะเป็นของ Xfce
